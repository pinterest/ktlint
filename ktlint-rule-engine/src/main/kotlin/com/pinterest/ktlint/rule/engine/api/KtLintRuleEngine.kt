...
import com.pinterest.ktlint.rule.engine.internal.RuleExecutionException
...
public class KtLintRuleEngine(
    ...
    public fun transformToAst(codeSnippet: Code.CodeSnippet): FileASTNode = createRuleExecutionContext(this, codeSnippet).rootNode
