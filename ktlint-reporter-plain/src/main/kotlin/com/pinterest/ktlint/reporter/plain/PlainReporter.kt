...
public class PlainReporter(
    ...
    public val groupByFile: Boolean = false,
    public val shouldColorOutput: Boolean = false,
    public val outputColor: Color = Color.DARK_GRAY,
    public val pad: Boolean = false
) : Reporter {
