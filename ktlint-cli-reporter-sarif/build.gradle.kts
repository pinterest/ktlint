...
publishing {
    publications {
        create<MavenPublication>("relocation-ktlint-cli-reporter-sarif") {
            pom {
                // Old artifact coordinates
                groupId = "com.pinterest.ktlint"
                artifactId = "ktlint-reporter-sarif"
                ...
                distributionManagement {
                    relocation {
                        ...
                        artifactId.set("ktlint-cli-reporter-sarif")
                        version.set("1.0.0")
...
signing {
    ...
    sign(publishing.publications["relocation-ktlint-cli-reporter-sarif"])
