...
import com.pinterest.ktlint.ruleset.core.api.ElementType.ARRAY_ACCESS_EXPRESSION
import com.pinterest.ktlint.ruleset.core.api.ElementType.ARROW
import com.pinterest.ktlint.ruleset.core.api.ElementType.BINARY_EXPRESSION
import com.pinterest.ktlint.ruleset.core.api.ElementType.BINARY_WITH_TYPE
import com.pinterest.ktlint.ruleset.core.api.ElementType.BLOCK
import com.pinterest.ktlint.ruleset.core.api.ElementType.BLOCK_COMMENT
import com.pinterest.ktlint.ruleset.core.api.ElementType.BODY
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.CONDITION
import com.pinterest.ktlint.ruleset.core.api.ElementType.CONSTRUCTOR_DELEGATION_CALL
import com.pinterest.ktlint.ruleset.core.api.ElementType.CONTEXT_RECEIVER_LIST
import com.pinterest.ktlint.ruleset.core.api.ElementType.DELEGATED_SUPER_TYPE_ENTRY
import com.pinterest.ktlint.ruleset.core.api.ElementType.DESTRUCTURING_DECLARATION
import com.pinterest.ktlint.ruleset.core.api.ElementType.DOT
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.ELVIS
import com.pinterest.ktlint.ruleset.core.api.ElementType.EQ
import com.pinterest.ktlint.ruleset.core.api.ElementType.FOR
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.IF
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.KDOC_LEADING_ASTERISK
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.LBRACKET
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.OPEN_QUOTE
import com.pinterest.ktlint.ruleset.core.api.ElementType.OPERATION_REFERENCE
import com.pinterest.ktlint.ruleset.core.api.ElementType.PARENTHESIZED
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.SAFE_ACCESS_EXPRESSION
import com.pinterest.ktlint.ruleset.core.api.ElementType.SECONDARY_CONSTRUCTOR
import com.pinterest.ktlint.ruleset.core.api.ElementType.SHORT_STRING_TEMPLATE_ENTRY
import com.pinterest.ktlint.ruleset.core.api.ElementType.STRING_TEMPLATE
import com.pinterest.ktlint.ruleset.core.api.ElementType.SUPER_TYPE_CALL_ENTRY
import com.pinterest.ktlint.ruleset.core.api.ElementType.SUPER_TYPE_ENTRY
import com.pinterest.ktlint.ruleset.core.api.ElementType.SUPER_TYPE_LIST
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.TYPE_CONSTRAINT
import com.pinterest.ktlint.ruleset.core.api.ElementType.TYPE_CONSTRAINT_LIST
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.USER_TYPE
...
import com.pinterest.ktlint.ruleset.core.api.ElementType.WHEN
