...
import com.pinterest.ktlint.ruleset.core.api.ElementType.ANNOTATION_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.COMPANION_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.CONST_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.DATA_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.ENUM_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.EXPECT_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.EXTERNAL_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.FINAL_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.INFIX_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.INLINE_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.INNER_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.INTERNAL_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.LATEINIT_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.OPEN_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.OPERATOR_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.OVERRIDE_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.PRIVATE_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.PROTECTED_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.PUBLIC_KEYWORD
import com.pinterest.ktlint.ruleset.core.api.ElementType.SEALED_KEYWORD
